...
public class MyConsumer {
    ...
    private final KafkaConsumer<Long, GeneratedMessageV3> kafkaConsumer;
    ...
    public MyConsumer() {
        ...
        props.put(TYPE_REFERENCE, new TypeReference<GeneratedMessageV3>() {});
    ...
    public KafkaConsumer<Long, GeneratedMessageV3> getConsumer() {
